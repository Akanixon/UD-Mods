...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition Railgun => new WeaponDefinition
        {
            ...
            {
                WeaponName = "Railgun", // name of weapon in terminal
                ...
                HardWare = new HardwareDef
                {
                    ...
                    MaxElevation = 35,
                    FixedOffset = false,
                    InventorySize = 0.600f,
                    Offset = Vector(x: 0, y: 1.579, z: -0.522),
                },
                Other = new OtherDef
                {
                    GridWeaponCap = 0,
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcMK1CoilCannon", // WepShipGatlingShot
