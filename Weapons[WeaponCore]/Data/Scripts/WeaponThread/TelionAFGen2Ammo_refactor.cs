...
{ // Don't edit above this line
    ...
    {
        private AmmoDef WolfSlug40mm => new AmmoDef
        {
            AmmoMagazine = "WolfSlug40mm",
            AmmoRound = "WolfSlug40mm",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "Exp_Spark_noShockwave",
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 10, green: 12, blue: 20, alpha: 5),
