...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition HeavyDefenseTurret => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                Threats = new[]
                {
                    Characters, Grids, Meteors, Other,
                },
                SubSystems = new[]
                {
            ...
            {
                WeaponName = "Heavy Defense Turret", // name of weapon in terminal
                DeviateShotAngle = 0.65f,
                ...
                {
                    PreFiringSound = "ArcHDTCannonShot",
                    FiringSound = "ArcHDTCannonShot", // WepShipGatlingShot
