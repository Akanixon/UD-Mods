...
{ // Don't edit above this line
    partial class Weapons
    {
        private AmmoDef ABShell40mmAmmo => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "Exp_Spark_Shockwave", //ShipWelderArc
        ...
        private AmmoDef ABShellShrapnel => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "ABShellShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "", //ShipWelderArc
                        Color = Color(red: 300, green: 0, blue: 0, alpha: 32),
                        Offset = Vector(x: 0, y: -1, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f,
                        Width = 2.0f,
                        Color = Color(red: 6, green: 20, blue: 6, alpha: 5),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
