...
{ // Don't edit above this line
    ...
    {
        private AmmoDef TorpedoMk1Ammo => new AmmoDef
        {
            AmmoMagazine = "TorpedoMk1",
            AmmoRound = "TorpedoMk1_Type1",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 10000f,
            Mass = 500f, // in kilograms
            Health = 700f, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 2.5f,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Explosions = new ExplosionDef
                {
                    ...
                    NoSound = false,
                    Scale = 2,
                    CustomParticle = "MyExplosionMissile",
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    Aggressiveness = 1.0f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.6f, // controls how sharp the trajectile may turn
            ...
            {
                ModelName = "\\Models\\Cubes\\large\\M1_Torpedo\\M1_Torpedo_projectile.mwm",
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "MyExplosionMissile",
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 5, green: 5, blue: 10, alpha: 2),
