...
{ // Don't edit above this line
    ...
    {
        private AmmoDef Ammo900mmShell => new AmmoDef
        {
            AmmoMagazine = "900mmShell",
            AmmoRound = "Ammo900mmShell",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 4000f, // in kilograms
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                AreaEffectDamage = 17000f, // 0 = use spillover from BaseDamage, otherwise use this value.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "", //ShipWelderArc
                        Color = Color(red: 128, green: 0, blue: 0, alpha: 1),
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "Exp_Spark_large_v2", //ShipWelderArc Exp_ShockSpark
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 2, green: 6, blue: 6, alpha: 5),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f,
                        Width = 0.5f,
                        Color = Color(red: 6, green: 9, blue: 9, alpha: 2),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        ...
                        DecayTime = 5,
                        Color = Color(red: 2, green: 3, blue: 3, alpha: 1),
                        Back = false,
                        CustomWidth = 0.3f,
