...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition M2Destroyer => new WeaponDefinition
        {
            ...
            {
                WeaponName = "M2 Destroyer", // name of weapon in terminal
                DeviateShotAngle = 8f,
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 0,
                    DelayAfterBurst = 420, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    FireFullBurst = false,
                },
            ...
            Ammos = new[] {
                DestroyerMissileMk1_Ammo
            },
            
            Animations = M2DestroyerAnimations,
        };
    }
}