...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition TelionAMACM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[]
                {
                    new MountPointDef
                    {
                        SubtypeId = "TelionAMACM",
                        AimPartId = "MissileTurretBarrels",
                        MuzzlePartId = "GatlingBarrel",// GatlingBarrel
            ...
            {
                WeaponName = "TelionGatling", // name of weapon in terminal
                DeviateShotAngle = 0.025f,
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcTelionAntiMissile", // WepShipGatlingShot
